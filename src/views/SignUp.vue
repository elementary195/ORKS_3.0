      ...
      <v-col cols="9" sm="7" md="5" lg="3">
        <v-card class="elevation-12">
          ...
          <v-card-actions class="mb-5 justify-center">
            ...
            <v-btn color="blue" depressed @click.prevent="signUp" class="white--text pa-5"
                   :light="!valid || getProcess" :disabled="getProcess || this.$v.$invalid">Зарегистрироваться</v-btn>
